...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> Masala Ingradient
    </div>

    <div class="card-body">
        <form action="<?php echo e(route("admin.masalaIngradients.update", [$product->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.3\htdocs\Ecommerce\resources\views/admin/masalaIngradients/edit.blade.php ENDPATH**/ ?>